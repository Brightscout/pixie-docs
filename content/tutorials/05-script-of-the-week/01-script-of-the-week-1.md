...
Pixie's scripts are written using the [Pixie Language](https://docs.pixielabs.ai/reference/pxl/) (PxL), a domain-specific language that is heavily influenced by [Pandas](https://pandas.pydata.org/docs/user_guide/index.html), a popular Python data processing library.
